...
def perform_action_based_on_next_delivery():
    ...
    next_delivery, next_delivery_time, min_time_difference = get_next_delivery(
...
def get_moer(token):
    ...
    start_time_utc = current_time_detroit.astimezone(
    ...
    params = {"region": "MISO_DETROIT", "signal_type": "co2_moer", "horizon_hours": 48}
...
for entry in pre_data["data"]:
    ...
    data.append({"point_time": adjusted_time.isoformat(), "value": entry["value"]})
